...
// console.log(output_path);
 generate_proof(TypeCredential.DrivingLicence,TypeProof.IssuanceDate, "credentials/identity_credentials_driving_license.csv",100,100,"credentials/run1_trial3_issuance_100")