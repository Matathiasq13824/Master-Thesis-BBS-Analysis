...
import {get_random_image_signature, get_random_image_byte_array,
  get_row_table_from_csv, get_zla_code_identity_card,get_random_first_name,
  get_column_table_from_csv, get_random_value_from_array, get_random_number, 
  get_random_gender, get_random_age_identity_card, 
  get_random_start_and_expiration_date_identity_card, get_random_AVS_number, 
  get_random_height } from './utils';
...
// Function to recover the schema of the identity card
...
// Function to generate an identity card identity
  ...
  return {
    credential:{
      ...
      credentialSubject: {
          ...
          issuanceDate :issuance_expiration_dates.issuance_date-relative_min_date,
          expirationDate :issuance_expiration_dates.expiration_date-relative_min_date,
          avs: get_random_AVS_number(),
          size: get_random_height(gender,age.age),
          birthDate: age.birth_date-relative_min_date,
